<script>
    ...
    import { getLocalizedText, getLocalizedTextBySlug, getMapById, getMaximumReal } from 'senselogic-gist';
...
<AccountMobileHeader title={ getLocalizedTextBySlug( 'ad-rental-file-label', $languageTagStore ) }  />
<div class="rental-file" class:wait={ isSubmitting }>
    {#if isLoading }
        <Loading />
    {:else}
        <div class="rental-file-content">
            <Alert
                type="informative"
            ...
            <div class="page-section-container">
                ...
                >
                    <CounterInput
                        name="signatory-count"
                        minCount={ 1 }
                        maxCount={ getMaximumReal( 5, leaseContract.adultCount ) }
